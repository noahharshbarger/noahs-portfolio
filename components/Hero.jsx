  ...
  return (
    <section id="aboutme" className="w-full min-h-[80vh] flex flex-col justify-center items-center px-0 py-0 bg-white border-b-4 border-[#f6c453] pb-24">
      ...
      <div className="flex gap-6">
        ...
        <a href="mailto:noah@example.com" className="bg-[#218380] hover:bg-[#f6c453] text-white px-8 py-3 rounded-xl font-bold shadow-lg transition-all text-lg border-2 border-[#218380] hover:text-[#1a2238]">Contact</a>
      </div>
    </section>
  );
}
