...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col items-center justify-center py-16 px-0 bg-[#1a2238] border-t-4 border-[#f6c453]">
      ...
      <div className="text-[#f5f6fa] text-base mb-2">Contact: <a href="mailto:noahharshb@gmail.com" className="text-[#218380] hover:underline font-semibold">noahharshb@gmail.com</a></div>
